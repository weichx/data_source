...
//this matters because of return types for adapter functions, without this whatever the base  adapter class returns
//from these methods will be the required return type for all extending classes
